...
<div class="container">
    <div class="row justify-content-center">
            ...
            <div class="card" style="width: 1000px;">
                <div class="card-header">Delete Database Threshold Profile</div>

                <div class="card-body">
                {{ Form::open(array('url' => 'databasethresholdprofiles/remove')) }}
                    <input type="hidden" id="database_threshold_profile_id" name="database_threshold_profile_id" value="{{ $profile->database_threshold_profile_id }}" />
                        <div class="form-group">
                            <h6 style="text-align: center;">Are you sure you wish to delete database threshold profile "{{$profile->profile_name}}"?</h6>
                       </div>
