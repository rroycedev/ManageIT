                            ...
                            <tr>
                                <td style="vertical-align: top;">
                                    <div>
                                        ...
                                        <input id="name" name="name" type="text" class="form-control" style="width: 400px;" value="{{ $server->server_name }}" />
                                    </div>
...
?>
                        ...
                        <div class="form-group" style="width: 80px;margin:auto;margin-top: 20px;">
